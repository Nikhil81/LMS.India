...
namespace GLOCart.BusinessServices.Services
{
    public class UserService
    {
        ...
        ////{
        ////    return _unitofwork.UsersRepository.GetByKey(userName);
        ////}
        ...
        //    {
        //        cfg.CreateMap<GLOUser, User>()
        //        .ForMember(dst => dst.Login, src => src.MapFrom<string>(e => e.login))
        //        .ForMember(dst => dst.DisplayName, src => src.MapFrom<string>(x => x.displayname))
        //        .ForMember(dest => dest.FirstName, src => src.MapFrom<string>(x => x.firstname))
        //        .ForMember(dest => dest.LastName, src => src.MapFrom<string>(x => x.lastname))
        //        .ForMember(dest => dest.Email, src => src.MapFrom<string>(x => x.email))
        //        .ForMember(dest => dest.TinyAvatar, src => src.MapFrom<string>(x => x.tiny_avatar))
        //        .ForMember(dest => dest.SmallAvatar, src => src.MapFrom<string>(x => x.small_avatar))
        //        .ForMember(dest => dest.Ecode, src => src.MapFrom<string>(x => x.ecode))
        //        .ForMember(dest => dest.Designation, src => src.MapFrom<string>(x => x.designation))
        //        .ForMember(dest => dest.RoleType, src => src.MapFrom<RoleType>(x => x.RoleType));
